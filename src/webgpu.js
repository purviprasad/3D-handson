...
async function init() {
    ...
    // This creates the 3D arrows used to move/rotate the object itself.
    ...
    loader.load('./src/models/advanced-ergonomic-chair.glb', function (gltf) {
        ...
        if (variantsExtension && variantsExtension.variants) {
            ...
            // Extract just the names of the variants (e.g. "midnight", "beach")
...
function onWindowResize() {
    ...
    // You MUST call this after changing the camera properties.
...
/**
 * This is the main loop function that runs 60 times a second.
 */
function animate() {
